...
{{--                                    ดาวน์โหลดเอกสาร:--}}
{{--                                    <div>--}}
{{--                                        <a href="{{ asset($portfolioAcademicTeaching->documents) }}" target="_blank">--}}
{{--                                            {{ asset($portfolioAcademicTeaching->documents) }}--}}
{{--                                        </a>--}}
{{--                                    </div>--}}
{{--                                </td>--}}
{{--                            </tr>--}}
...
{{--                    ดาวน์โหลดเอกสาร--}}
{{--                    <div>--}}
{{--                        <a href="{{ asset($portfolioAcademicResearch->documents) }}" target="_blank">--}}
{{--                            {{ asset($portfolioAcademicResearch->documents) }}--}}
{{--                        </a>--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--                @endif--}}
...
{{--                                    <a href="{{ asset($portfolioAcademicStudentAdvisory->documents) }}" target="_blank">--}}
{{--                                        ดาวน์โหลด--}}
{{--                                    </a>--}}
{{--                                    @endif--}}
{{--                                </td>--}}
...
{{--                                    <a href="{{ asset($portfolioAcademicStudentActivityAdvisory->documents) }}" target="_blank">--}}
{{--                                        ดาวน์โหลด--}}
{{--                                    </a>--}}
{{--                                    @endif--}}
{{--                                </td>--}}
...
{{--                                    <a href="{{ asset($portfolioAcademicWork->documents) }}" target="_blank">--}}
{{--                                        ดาวน์โหลด--}}
{{--                                    </a>--}}
{{--                                    @endif--}}
{{--                                </td>--}}
...
{{--                                    <a href="{{ asset($portfolioAcademicService->documents) }}" target="_blank">--}}
{{--                                        ดาวน์โหลด--}}
{{--                                    </a>--}}
{{--                                    @endif--}}
{{--                                </td>--}}
...
{{--                                    <a href="{{ asset($portfolioAcademicAdministrativeWork->documents) }}" target="_blank">--}}
{{--                                        ดาวน์โหลด--}}
{{--                                    </a>--}}
{{--                                    @endif--}}
{{--                                </td>--}}
...
{{--                                    <a href="{{ asset($portfolioAcademicOtherWork->documents) }}" target="_blank">--}}
{{--                                        ดาวน์โหลด--}}
{{--                                    </a>--}}
{{--                                    @endif--}}
{{--                                </td>--}}
...
{{--                                    <a href="{{ asset($portfolioAcademicOtherService->documents) }}" target="_blank">--}}
{{--                                        ดาวน์โหลด--}}
{{--                                    </a>--}}
{{--                                    @endif--}}
{{--                                </td>--}}
...
{{--                                    <a href="{{ asset($portfolioAcademicOtherAward->documents) }}" target="_blank">--}}
{{--                                        ดาวน์โหลด--}}
{{--                                    </a>--}}
{{--                                    @endif--}}
{{--                                </td>--}}
...
{{--                                    <a href="{{ asset($portfolioAcademicOtherImpressed->documents) }}" target="_blank">--}}
{{--                                        ดาวน์โหลด--}}
{{--                                    </a>--}}
{{--                                    @endif--}}
{{--                                </td>--}}
