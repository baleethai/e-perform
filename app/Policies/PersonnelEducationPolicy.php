...
class PersonnelEducationPolicy
{
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function view(User $user, PersonnelEducation $personnelEducation): bool
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function update(User $user, PersonnelEducation $personnelEducation): bool
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function delete(User $user, PersonnelEducation $personnelEducation): bool
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function forceDelete(User $user, PersonnelEducation $personnelEducation): bool
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function restore(User $user, PersonnelEducation $personnelEducation): bool
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function replicate(User $user, PersonnelEducation $personnelEducation): bool
    {
