...
class PersonnelExpertisePolicy
{
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function view(User $user, PersonnelExpertise $personnelExpertise): bool
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function update(User $user, PersonnelExpertise $personnelExpertise): bool
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function delete(User $user, PersonnelExpertise $personnelExpertise): bool
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function forceDelete(User $user, PersonnelExpertise $personnelExpertise): bool
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function restore(User $user, PersonnelExpertise $personnelExpertise): bool
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function replicate(User $user, PersonnelExpertise $personnelExpertise): bool
    {
