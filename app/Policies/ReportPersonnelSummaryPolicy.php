...
class ReportPersonnelSummaryPolicy
{
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function view(User $user, ReportPersonnelSummary $reportPersonnelSummary)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function update(User $user, ReportPersonnelSummary $reportPersonnelSummary)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function delete(User $user, ReportPersonnelSummary $reportPersonnelSummary)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function forceDelete(User $user, ReportPersonnelSummary $reportPersonnelSummary)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function restore(User $user, ReportPersonnelSummary $reportPersonnelSummary)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function replicate(User $user, ReportPersonnelSummary $reportPersonnelSummary)
    {
